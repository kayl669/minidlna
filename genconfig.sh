...
echo "#define OS_URL                    \"http://sourceforge.net/projects/minidlna/\"" >> ${CONFIGFILE}
echo "#define ROOTDEV_MANUFACTURER      \"Justin Maggard\"" >> ${CONFIGFILE}
echo "#define ROOTDEV_MANUFACTURERURL   \"http://www.netgear.com/\"" >> ${CONFIGFILE}
echo "#define ROOTDEV_MODELNAME         \"Windows Media Connect compatible (MiniDLNA)\"" >> ${CONFIGFILE}
echo "#define ROOTDEV_MODELDESCRIPTION  \"MiniDLNA on \"OS_NAME" >> ${CONFIGFILE}
echo "#define ROOTDEV_MODELURL          OS_URL" >> ${CONFIGFILE}
echo "" >> ${CONFIGFILE}
...
echo "#define HAVE_INOTIFY" >> ${CONFIGFILE}
echo "" >> ${CONFIGFILE}
